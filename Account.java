...
/**
 * The account for the social media user.
 * 
...
public class Account implements Serializable{
    ...
    private String handle; // =< 30 character | Seperate class to check for existing handle
    ...
    /**
     * Changes the users handle to the new one specified if it is =< 30 chars, no whitespace and not empty
     * 
