...
/**
 * A deleted post is used when a post is removed from the system however, it
 * still has child posts, this then allows those posts to still have a post to
 * link to within the system.
 * 
 * @version 1.0
 */
